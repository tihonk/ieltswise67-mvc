...
import com.ieltswise.controller.StudentController;
...
public class StudentControllerImpl implements StudentController {
    ...
    @Autowired
    StudentControllerImpl(BookingService calendarMailService,
    ...
    public ResponseEntity<SessionDataResponse> bookTrialSession(@RequestBody SessionDataRequest sessionData)
            throws Exception {
    ...
    public ResponseEntity<SessionDataResponse> bookRegularSession(
            @RequestBody RegularSessionDataRequest regularSessionDataRequest) throws Exception {
